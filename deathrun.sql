...
--
-- Host: iswenzz.com    Database: deathrun
-- ------------------------------------------------------
...
CREATE TABLE `bans` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `guid` varchar(8) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `player` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `steamId` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `leaderboards` (
  ...
  `time` int NOT NULL,
  `name` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `mode` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `way` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `player` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `run` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `tas` int NOT NULL DEFAULT '0',
  `date` datetime NOT NULL DEFAULT '2025-01-01 00:00:00',
  PRIMARY KEY (`id`)
...
CREATE TABLE `pbs` (
  ...
  `way` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `player` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `run` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `date` datetime NOT NULL DEFAULT '2025-01-01 00:00:00',
  PRIMARY KEY (`id`)
...
CREATE TABLE `ranks` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `speedrun_ranks_un` (`player`)
...
CREATE TABLE `scores` (
  ...
  `player` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `name` varchar(36) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `score` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `value` int NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping routines for database 'deathrun'
--
...
-- Dump completed on 2026-01-20 12:58:08
