main()
{
	...
	maps\mp\_load::main();
	maps\mp\mp_deathrun_horror\_horror_acti_skin::main();
	maps\mp\mp_deathrun_horror\_horror_jumper_skin::main();
	maps\mp\mp_deathrun_horror\_teleport1::main();
	maps\mp\mp_deathrun_horror\_teleport2::main();
	maps\mp\mp_deathrun_horror\_teleport3::main();
	maps\mp\mp_deathrun_horror\_teleport4::main();
...
end_sr()
{
	t1 = spawn("trigger_radius",(-2051,-6275,172-30),0,150,200);
	t1 thread endmap();
}
