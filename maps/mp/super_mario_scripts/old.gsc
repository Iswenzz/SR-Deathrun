...
{
	level.mreza_old = getEnt( "mreza_old", "targetname" );
	level.mreza_w = getEnt( "mreza_w", "targetname" );
	level.mreza_s = getEnt( "mreza_s", "targetname" );
	level.trigg_old = getEnt( "trigg_old", "targetname" );
	level.old_fx = getent ( "old_fx" ,"targetname" ); //origin
	level.gohere3 = getent ( "gohere3" ,"targetname" ); //origin
}
