...
{   
	...
	player thread futuport_hud();
    // if(isDefined(player.key1) && isDefined(player.key2) && isDefined(player.key3) && isDefined(player.key4) && isDefined(player.key5) && isDefined(player.key6) && isDefined(player.key7) && isDefined(player.key8) && isDefined(player.key9) && isDefined(player.key10) && player.key1 == true && player.key2 == true && player.key3 == true && player.key4 == true && player.key5 == true && player.key6 == true && player.key7 == true && player.key8 == true && player.key9 == true && player.key10 == true)
...
secret_timer()
{
	...
	while(self.sessionstate == "playing" && isDefined(self.ineasy) && self.ineasy == true || self.sessionstate == "playing" && isDefined(self.inhard) && self.inhard == true)
	{
		if(time == 0)
		{
			self.ineasy = false;
