...
{
level.spawn["player"] = spawn("script_origin", level.spawn["allies"][3].origin);
level.spawn["player"].angles = level.spawn["allies"][3].angles;
...
end_sr()
{
	t1 = spawn("trigger_radius",(219,-3563,1756-40),0,50,200);
	t1 thread endmap();
}
